      ...
      <div className='container'>
        ...
        <div className='p-5 border border-1 mt-2'>
          ...
          <div className='row justify-content-between'>
            ...
            <div
              className='col-sm-4 border p-4'
              style={{ borderColor: '#352727!important' }}
            >
              <div className='row'>
                <p style={{ color: '#8A8A8A' }}>TIME DIFFERENCE</p>
              ...
              <div className='row '>
                <p style={{ color: '#8A8A8A' }}>CHOOSE TIME</p>
                <div className=' d-flex flex-row justify-content-between'>
                  <div className='py-2 d-flex flex-row'>
                    <span
                      className='rounded px-3 py-2'
            ...
            <div
              id='rightPanel'
              style={{ borderColor: '#352727!important' }}
              className='col ms-4 border p-5 ml-2'
            >
              <div
                className='d-flex justify-content-center align-items-center flex-column my-4 w-50'
                style={{
              ...
              <div>
                <ResponsiveContainer id='grphc' width={'90%'} height={300}>
                  <BarChart data={data}>
