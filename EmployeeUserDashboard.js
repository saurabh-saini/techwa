...
import './EmployeeUserDashboard.css';
    ...
    <div>
      ...
      <div className='container'>
        <div className='row d-flex justify-content-between align-items-center mt-3'>
          ...
          <div className='col align-items-center nameBox'>
        ...
        <div className='p-5 border border-1 mt-2'>
          ...
          <div className='row justify-content-between'>
            ...
            <div className='col-sm-4  p-4'>
              ...
              <div className=' p-3 mt-2' style={{ backgroundColor: '#E2E2E2' }}>
                <div
            ...
            <div id='rightPanel' className='col ms-4 p-5 ml-2'>
              <div className=''>
                <div>
                  ...
                  <div className='p-3 border  dj' style={{}}>
                ...
                <div className='mt-2'>
                  <h5>History</h5>
                  <div className='p-3 border  dj' style={{}}>
                    <ResponsiveContainer id='grphc' width={'100%'} height={300}>
                      <BarChart data={data}>
